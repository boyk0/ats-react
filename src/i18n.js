...
const resources = {
	en: {
		translation: {
			...
			"Login login": "Go",
			"English level Basic": "Basic",
			"English level Pre-intermediate": "Pre-intermediate",
			"English level Intermediate": "Intermediate",
			"English level Upper-intermediate": "Upper-intermediate",
			"English level Advanced": "Advanced",
			"Statuses - Contacted": "Contacted",
			"Statuses - Interested": "Interested",
			"Statuses - Pre-screen": "Pre-screen",
			"Statuses - Test Task": "Test Task",
			"Statuses - Technical Interview": "Technical Interview",
			"Statuses - Final Interview": "Final Interview",
			"Statuses - Offer": "Offer",
			"Statuses - Hired": "Hired",
		}
	},
};
